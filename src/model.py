...
class HParams:
    """Replacement for obsolete tf.contrib.training.HParams"""
    [n_vocab, n_ctx, n_embd, n_head, n_layer] = [3,1024,768,12,12]
    def vars(self): return(vars())
    
    def override_from_dict(self, in_dict):
        self.__dict__ = in_dict.copy()
        return(self)
